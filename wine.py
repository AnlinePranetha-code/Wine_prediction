...
print("\n---About Dataset---")
print("The graph shows that most wine samples have quality scores of 5 and 6")
print("Meaning the dataset is dominated by average-quality wines") 
print("High-quality (7–8) and low-quality (3–4) wines are much fewer")
